                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;color:#64748B;line-height:1.6;">
                                Hi {{ $userName }}, use the code below to confirm your email address.
                                It expires in <strong>10 minutes</strong>.
                            </p>

                            {{-- OTP box --}}
                            <div style="background:#F1F5F9;border-radius:12px;padding:28px;text-align:center;margin-bottom:28px;">
                                <p style="margin:0 0 6px;font-size:12px;font-weight:600;color:#94A3B8;text-transform:uppercase;letter-spacing:1px;">
                                    Verification Code
                                </p>
                                <p style="margin:0;font-size:42px;font-weight:700;color:#3F51B5;letter-spacing:10px;">
                                    {{ $otp->otp }}
                                </p>
                            </div>

                            <p style="margin:0;font-size:13px;color:#94A3B8;line-height:1.6;">
                                If you didn't create an account with Intelligent Accelerators, you can safely ignore this email.
                            </p>
                        </td>
                    </tr>
