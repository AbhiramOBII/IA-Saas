<div>
    <h2 class="text-xl font-semibold text-ia-text mb-1">Welcome back</h2>
    ...
    <form wire:submit="login" novalidate>
        ...
        {{-- Email --}}
        <div class="mb-5">
            <label for="email" class="block text-sm font-medium text-ia-text mb-1.5">
                Email address
            </label>
            <input
                wire:model="email"
            ...
            >
            @error('email')
                <p class="mt-1.5 text-xs text-ia-error">{{ $message }}</p>
            @enderror
        </div>

        {{-- Password --}}
        <div class="mb-5" x-data="{ show: false }">
            <label for="password" class="block text-sm font-medium text-ia-text mb-1.5">
                Password
            </label>
            <div class="relative">
                <input
        ...
        <div class="flex items-center mb-6">
            <input
                ...
                id="remember"
                type="checkbox"
                class="w-4 h-4 rounded border-slate-300 text-ia-primary focus:ring-ia-primary/40 cursor-pointer"
            >
